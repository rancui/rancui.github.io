...
title: H5动画之逐帧动画
subtitle: 
date: 2018-05-22 10:31:50
thumbnail: //img.aotu.io/Yettyzyt/css3-animation-frame/sfs.jpg
categories: Web开发
tags:
  - 动画
author:
...
- `step-start` 等同于 `steps(1,start)`：在变化过程中，都是以下一帧的显示效果来填充间隔动画；
- `step-end` 等同于 `steps(1,end)`：都是以上一帧的显示效果来填充间隔动画。
